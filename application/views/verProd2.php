...
<script type="text/javascript">
   function Registrar() {           
       ...
       console.log(nombre);                          
        ...
        $.ajax({
            type: "GET",            
            url:"http://localhost/fundamentos/index.php/introduccion/buscarProd",
            data:{'nombre': nombre},
    ...
    <div class="container">        
        <!-- Form -->
            <section>
                ...
                <form action ="buscarProd2" onsubmit = "return Registrar()" method="get" name="sentMessage" id="consultaForm" novalidate>
